...
from .views import PatientViewSet, PatientRegisterSet, DoctorViewSet, DoctorAppointmentViewSet
...
urlpatterns = [
    ...
    path('doctors-appointments/', DoctorAppointmentViewSet.as_view(), name='doctor-appointment'),
